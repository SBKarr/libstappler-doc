...
Макрос версионирования пространства имён. Для сборки библиотек к пространству имён может быть добавлена строка версии, чтобы функции в глобальном пространстве имён не пересекались.
